...
public class Instructor extends User {
    ...
    public ReturnResult scheduleExam(String course, String instructor, String date, String startTime,
        ...
        if (result.isSuccess()) {
            ...
            try {
                int id = dbExam.addExam(course, instructor, date, startTime, endTime, room, program);
                if (id > 0) {
    ...
    public ReturnResult checkAvail(String room, String startTime, String endTime, String date, boolean isLabRequired) {
        dbExam = new DBExam();
        ...
        if (result.isSuccess()) {
            ...
            try {
                roomDetails = dbRoom.loadRoomDetails(room);
                ...
                if (result.isSuccess()) {
                    ArrayList<Exam> examSchedule = dbExam.loadExamScheduleByRoom(room, date);
